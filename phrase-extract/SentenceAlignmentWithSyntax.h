...
namespace MosesTraining
{
	...
	public:
		...
		/// There are cases that SRL information is not well aligned with sentences, so need to perform alignment. And
		/// bSource decides whehter to align it with source or target sentences
		bool virtual AlignSRLInformation(bool bSource);

		inline void setSRLInformation(std::vector<srl::SRLInformation>* srl) {srlInformation.reset(srl);}
