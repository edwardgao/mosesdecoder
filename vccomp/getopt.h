...
extern _GETOPT_API int _optind;
extern _GETOPT_API int _opterr;
...
extern _GETOPT_API int _getopt(int argc, TCHAR *const *argv, const TCHAR *optstring) _GETOPT_THROW;
